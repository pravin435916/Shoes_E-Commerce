        ...
        <>
            <div className='flex flex-col sm:flex-row justify-center sm:m-20 m-8 '>
                ...
                <div>
                    ...
                    <button className='h-8 w-32 rounded-md text-sm mt-5 hover:bg-orange-600 text-white bg-orange-400 sm:mr-5'>Shop Now</button>
                    <button className='h-8 w-32 text-sm rounded-md mt-5 hover:bg-orange-600 text-white bg-orange-400 sm:mr-5'>Add To Wishlist</button>
