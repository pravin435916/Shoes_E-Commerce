      ...
      <div className='flex flex-col justify-center sm:justify-center sm:flex sm:flex-row object-contain aspect-video gap-4 sm:m-32 m-4 rounded'>
        <div className='sm:grid sm:grid-cols-2 grid grid-row-2 gap-4 sm:justify-center '>
          <div className='sm:ml-16 relative overflow-hidden group'>
            <img src={whiteshoes} className='sm:h-72 sm:w-92' alt='White Shoes' />
          ...
          <div className='relative overflow-hidden group'>
            <img src={shoes1} className='sm:h-72 sm:w-100' alt='Shoes 1' />
            <div className='absolute top-0 left-0 w-full h-full bg-black bg-opacity-50  sm:h-72 sm:w-100 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
              <p className='text-white text-lg font-bold text-center'>Lorem Ipsum2</p>
            </div>
          </div>
          <div className='sm:ml-16 relative overflow-hidden group'>
            <img src={shoes2} className='sm:h-72 sm:w-100' alt='Shoes 2' />
          ...
          <div className='relative overflow-hidden group'>
            <img src={shoes3} className='sm:h-72 sm:w-84' alt='Shoes 3' />
            <div className='absolute top-0 left-0 w-full h-full  bg-black bg-opacity-50 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
        ...
        <div className='relative group overflow-hidden'>
          ...
          <div className='absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flext items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
