      ...
      <div className='w-full flex flex-col justify-center items-center overflow-hidden'>
        <div className='w-[70%] border shadow-2xl p-7 mt-8 flex flex-col sm:flex-row items-center justify-between bg-white z-10 '>
          ...
          <div className='flex gap-8 justify-center items-center sm:flex-row flex-col'>
            ...
            <Link className='hover:text-orange-600' to='/shop'>
              Shop
            </Link>
            <Link className='hover:text-orange-600' to='/blog'>
              Blog
            </Link>
            <Link className='hover:text-orange-600' to='/pages'>
              Pages
            </Link>
            ...
            <span className='hover:text-orange-600 cursor-pointer' onClick={opensearch}>
              <IoMdSearch />
            </span>
            <Link className='hover:text-orange-600 cursor-pointer' to='/contact'>
              <FaRegUser />
            </Link>
          </div>
        </div>
        {bar && (
          <motion.div
            ...
            <span className='cursor-pointer' onClick={opensearch}>
              <RxCross2 />
            </span>
          </motion.div>
        )}
